...
original_author="PingNasa"
original_name="oitavo"
original_urlname="oitavo"
original_description="Awesome oitavo created by PingNasa" 
...
then
    ...
    echo "then run 'oitavo' or 'python -m oitavo'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'oitavo' or 'python -m oitavo' or 'poetry run oitavo'"
fi
